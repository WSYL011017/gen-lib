...
public class GenLibIntegrationTest {
    ...
    public void testCoreComponentsIntegration() {
        // 测试核心工具类
        String result = StringUtils.toCamelCase("hello_world");
    ...
    public void testConfigManagerIntegration() {
        if (configManager != null) {
            // 测试配置管理
            String appName = configManager.getConfig("spring.application.name", String.class, "default-app");
    ...
    public void testPerformanceIntegration() {
        ...
        for (int i = 0; i < 100; i++) {
            String result = StringUtils.toCamelCase("test_string_" + i);
